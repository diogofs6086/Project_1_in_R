...
* [PART 1 - Data munging and testing models](source_githubio/project_click_fraud_1_data_munging_and_testing_models_in_a_sample.md/#part-one)
  ...
  * [Models](source_githubio/project_click_fraud_1_data_munging_and_testing_models_in_a_sample.md/#models)
    ...
    * [Model 11 - Regression Tree model](source_githubio/project_click_fraud_1_data_munging_and_testing_models_in_a_sample.md/#regression-tree-model)
    * [Model 12 - Regression Tree model with the most significant variables](source_githubio/project_click_fraud_1_data_munging_and_testing_models_in_a_sample.md/#regression-tree-model-with-the-most-significant-variables)
    * [Model 13 - Another Regression Tree model](source_githubio/project_click_fraud_1_data_munging_and_testing_models_in_a_sample.md/#another-regression-tree-model)
    * [Model 14 - Another Regression Tree model with the most significant variables](source_githubio/project_click_fraud_1_data_munging_and_testing_models_in_a_sample.md/#another-regression-tree-model-with-the-most-significant-variables)
