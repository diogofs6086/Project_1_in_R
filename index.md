...
* [Part 1 - Data munging and testing models](source_githubio/project_click_fraud_1_data_munging_and_testing_models_in_a_sample.md)
  ...
  * [Models](source_githubio/project_click_fraud_1_data_munging_and_testing_models_in_a_sample.md/#Models)
    ...
    * [Model 16 - Random forest model with the balanced target variable by reducing the quantity of not downloaded class](source_githubio/project_click_fraud_1_data_munging_and_testing_models_in_a_sample.md/#Random-forest-model-with-the-balanced-target-variable-by-reducing-the-quantity-of-not-downloaded-class)
